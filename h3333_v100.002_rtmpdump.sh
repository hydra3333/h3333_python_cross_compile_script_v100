...
./cross_compiler_v100_002.py list -p 2>&1 | tee -a ./rtmpdump.log
./cross_compiler_v100_002.py list -d 2>&1 | tee -a ./rtmpdump.log
...
./cross_compiler_v100_002.py --force --debug -d rtmpdump 2>&1 | tee -a ./rtmpdump.log
