...
rm -fv ./debug-ff-3333.log
#echo "# `date`" >>./debug-ff-3333.log
#echo 'find . -iname "*.exe" -print -delete '>>./debug-ff-3333.log
#find . -iname "*.exe" -print -delete 2>&1 | tee -a ./debug-ff-3333.log
...
./cross_compiler_v100_001.py list -p 2>&1 | tee -a ./debug-ff-3333.log
./cross_compiler_v100_001.py list -d 2>&1 | tee -a ./debug-ff-3333.log
...
./cross_compiler_v100_001.py --force --debug -p ffmpeg_3333 2>&1 | tee -a ./debug-ff-3333.log
exit_status=$?
