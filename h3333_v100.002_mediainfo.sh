...
./cross_compiler_v100_002.py list -p 2>&1 | tee -a ./mediainfo.log
./cross_compiler_v100_002.py list -d 2>&1 | tee -a ./mediainfo.log
...
./cross_compiler_v100_002.py --force --debug -d libmediainfo 2>&1 | tee -a ./mediainfo.log
