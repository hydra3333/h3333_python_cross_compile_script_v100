...
#sudo chmod -R a=rwx *.sh
#sudo chmod -R a=rwx *.py
#./cross_compiler_v100_003.py --force --debug --products --dependencies -pl ffmpeg_min
...
./cross_compiler_v100_003.py list -p 2>&1 | tee -a ./debug-ff_3333.log
./cross_compiler_v100_003.py list -d 2>&1 | tee -a ./debug-ff_3333.log
...
echo "# `date` ###################################################################################" >>./debug-ff_3333.log
./Remove_ffmpeg_3333_related_files.sh
./cross_compiler_v100_003.py --force --debug -p ffmpeg_3333 2>&1 | tee -a ./debug-ff_3333.log
exit_status=$?
