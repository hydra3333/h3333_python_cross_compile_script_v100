...
./cross_compiler_v100_001.py list -p 2>&1 | tee -a ./0.debug-x265.029.log
./cross_compiler_v100_001.py list -d 2>&1 | tee -a ./0.debug-x265.029.log
...
echo "# `date` ###################################################################################" >>./0.debug-x265.029.log
echo "# `date` ###################################################################################" >>./0.debug-x265.029.log
./cross_compiler_v100_001.py --force --debug -d libx265_multibit_10 2>&1 | tee -a ./0.debug-x265.029.log
./cross_compiler_v100_001.py --force --debug -d libx265_multibit_12 2>&1 | tee -a ./0.debug-x265.029.log
./cross_compiler_v100_001.py --force --debug -p x265_multibit 2>&1 | tee -a ./0.debug-x265.029.log
exit_status=$?
