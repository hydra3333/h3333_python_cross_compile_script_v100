...
./cross_compiler_v100_003.py list -p 2>&1 | tee -a ./mediainfo.log
./cross_compiler_v100_003.py list -d 2>&1 | tee -a ./mediainfo.log
...
./cross_compiler_v100_003.py --force --debug -d libmediainfo 2>&1 | tee -a ./mediainfo.log
