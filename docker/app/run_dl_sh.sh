...
curl --ipv4 https://raw.githubusercontent.com/hydra3333/h3333_python_cross_compile_script_v100/master/docker/app/v100.sh -O -L
...
sed -ibak 's;sudo ;;g' ./v100.sh
sed -ibak 's;~/Desktop;/;g' ./v100.sh
sed -ibak 's;/home/u/Desktop;/;g' ./v100.sh
sed -ibak 's;./exe_x64_py;/VM/exe_x64_py;g' ./v100.sh
