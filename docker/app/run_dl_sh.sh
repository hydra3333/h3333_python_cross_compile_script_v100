...
sed -i.bak 's;sudo ;;g' ./run_prep.sh
sed -i.bak 's;~/Desktop;/;g' ./run_prep.sh
sed -i.bak 's;/home/u/Desktop;/;g' ./run_prep.sh
sed -i.bak 's;./exe_x64_py;/VM/exe_x64_py;g' ./run_prep.sh
