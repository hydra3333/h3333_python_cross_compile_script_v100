...
rm -fv ./webp.log
#echo "# `date`" >>./webp.log
#echo 'find . -iname "*.exe" -print -delete '>>./webp.log
#find . -iname "*.exe" -print -delete 2>&1 | tee -a ./webp.log
...
./cross_compiler_v100_001.py list -p 2>&1 | tee -a ./webp.log
./cross_compiler_v100_001.py list -d 2>&1 | tee -a ./webp.log
...
#read -p "After build webp, press Enter to continue"
