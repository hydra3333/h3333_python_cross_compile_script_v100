...
#sudo chmod -R a=rwx *.sh
#sudo chmod -R a=rwx *.py
#./cross_compiler_v100_002.py --force --debug --products --dependencies -pl ffmpeg_static_non_free_opencl,x264_multibit
#./cross_compiler_v100_002.py --force --debug -p x264_multibit
# only use --force if ity's already been fully built, 
# or it breaks if you use it the first time
./cross_compiler_v100_002.py list -p 2>&1 | tee -a ./fftw3_dll.log
./cross_compiler_v100_002.py list -d 2>&1 | tee -a ./fftw3_dll.log
