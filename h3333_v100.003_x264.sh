...
./cross_compiler_v100_003.py list -p 2>&1 | tee -a ./debug-x264.log
./cross_compiler_v100_003.py list -d 2>&1 | tee -a ./debug-x264.log
...
./cross_compiler_v100_003.py --force --debug -d libx264 2>&1 | tee -a ./debug-x264.log
read -p "After build libx264, press Enter to continue"
./cross_compiler_v100_003.py --force --debug -p x264 2>&1 | tee -a ./debug-x264.log
exit_status=$?
