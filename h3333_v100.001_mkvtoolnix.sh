...
#echo "# `date`" >>./mkvtoolnix.log
#echo 'find . -iname "*.exe" -print -delete '>>./mkvtoolnix.log
...
./cross_compiler_v100_001.py list -p 2>&1 | tee -a ./mkvtoolnix.log
./cross_compiler_v100_001.py list -d 2>&1 | tee -a ./mkvtoolnix.log
