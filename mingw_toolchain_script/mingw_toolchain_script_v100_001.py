...
SOURCES['mingw-w64'] = { # https://sourceforge.net/p/mingw-w64/mingw-w64/ci/master/tree/
	...
	'checkout' : '4e51dfbf9baa34af596691342420bff4b5e3ded3', # Reverted per Bug Report https://sourceforge.net/p/mingw-w64/bugs/850/ to allow "ICD Loader" to build
...
SOURCES['gcc'] = { # https://www.gnu.org/software/gcc/ # https://ftp.gnu.org/gnu/gcc/ # ftp://ftp.fu-berlin.de/unix/languages/gcc/snapshots/
	...
	#'version': '11-20200517', # works # '11-20200621', fails with segmentation fault
