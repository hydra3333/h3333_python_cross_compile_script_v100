...
SOURCES['mingw-w64'] = { # https://sourceforge.net/p/mingw-w64/mingw-w64/ci/master/tree/
    ...
    'checkout' : 'tags/v10.0.0', # 2022.12.18 comment out # see the calling  .py  -'mingw_commit': 'tags/v10.0.0', 
    #
	#'git_shallow': True,
	#'url': 'https://git.code.sf.net/p/mingw-w64/mingw-w64',  # https://git.code.sf.net/p/mingw-w64/mingw-w64 mirror: https://github.com/mirror/mingw-w64.git but that seems suprisingly out of date sometimes.
	...
	'builds': [
		...
		#'mingw-w64-widl', # 2020.05.13 be the same as deadsix27
	]
}
...
SOURCES['binutils'] = { # https://ftp.gnu.org/gnu/binutils/
	'type': 'archive',
	'version': '2.37', # this version builds OK
...
SOURCES_proposed['binutils'] = { # https://sourceware.org/git/binutils-gdb.git 
	'type': 'git',
	'git_shallow': False,
    'checkout' : 'tags/binutils-2_37', # this buils OK
    #'checkout' : 'binutils-2_39', # 2.39 fails to build
	'branch' : '',
...
BUILDS['mingw-w64-headers'] = {
	'lineConfig':
		...
		' --enable-idl'
		#' --with-default-msvcrt=msvcrt' # 2022.12.18 per DEADSIX27 ... no comment out
		# ' --with-default-win32-winnt=0x600 '	, # 2022.12.18 per DEADSIX27 remove 0x600
	,
	'softLinks': [
		('{prefix}', './{target}', './mingw'),
...
BUILDS['mingw-w64-crt'] = {
	'lineConfig':
		...
		' --prefix="{prefix}"'
		' --target="{target}"'
		#' --with-default-msvcrt=msvcrt-os' # 2022.12.18 per DEADSIX27 ... NO COMMENT OUT
		#' --disable-lib32' # 2022.12.18 per DEADSIX27 ... NO COMMENT OUT
		' --with-sysroot={prefix}'	,
	'customCommands': [
