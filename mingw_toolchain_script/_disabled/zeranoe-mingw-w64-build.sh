...
# 2022.12.26 modify to default to similar to deadsix27, just to see what happens
...
ROOT_PATH="$HOME/Desktop/_working/workdir/toolchain/zeranoe"
echo "DEBUG: ROOT_PATH=$ROOT_PATH"


MINGW_W64_BRANCH="v10.0.0"
...
if [ ! "$BUILD_I686" ] && [ ! "$BUILD_X86_64" ]; then
	...
	BUILD_I686=0
	BUILD_X86_64=1
    echo "no ARCH was specified, defaulting to BUILD_X86_64=$BUILD_X86_64  BUILD_I686=$BUILD_I686"
fi
