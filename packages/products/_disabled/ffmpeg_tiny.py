{
	...
	'configure_options' : '!VAR(ffmpeg_tiny_config)VAR! --prefix={output_prefix}/ffmpeg_tiny_git.installed --disable-shared --enable-static',
	'depends_on' : [ 'ffmpeg_tiny_depends', ],
