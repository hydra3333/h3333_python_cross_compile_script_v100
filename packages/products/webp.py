{
	...
	'configure_options' : '.. {cmake_prefix_options} '
		...
		'-DWEBP_UNICODE=ON '
		'-DWEBP_BUILD_CWEBP=OFF ' # off
		'-DWEBP_BUILD_DWEBP=OFF ' # off
		'-DWEBP_BUILD_VWEBP=OFF ' # off
		'-DWEBP_BUILD_WEBPINFO=ON ' # off
		'-DWEBP_BUILD_WEBPMUX=ON ' # off
		'-DWEBP_BUILD_WEBPDEMUX=ON ' # off
		'-DWEBP_BUILD_EXTRAS=ON ' # off
