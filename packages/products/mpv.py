{
	...
	,
	'custom_cflag' : ' {original_cflag_trim} {original_stack_protector_trim} {original_fortify_source_trim} -L{output_prefix}/mpv_git.installed -L{target_prefix}/lib -lgpg-error -lgcrypt  -lglslang -lshaderc -lplacebo -lgpg-error -lgcrypt  -lglslang -lvulkan-1 -lz -ld3d11 -lintl -liconv ', # 2020.05.13 
