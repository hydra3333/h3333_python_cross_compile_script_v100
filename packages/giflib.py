{
	...
	'download_locations' : [
		...
		{ 'url' : 'https://sourceforge.net/projects/giflib/files/giflib-5.2.1.tar.gz' , 'hashes' : [ { 'type' : 'sha256', 'sum' : '31da5562f44c5f15d63340a09a4fd62b48c45620cd302f77a6d9acf0077879bd' }, ], }, # 2020.05.29
		{ 'url' : 'https://fossies.org/linux/misc/giflib-5.2.1.tar.gz'				  , 'hashes' : [ { 'type' : 'sha256', 'sum' : '31da5562f44c5f15d63340a09a4fd62b48c45620cd302f77a6d9acf0077879bd' }, ], },
	],
	# 'patches' : [
