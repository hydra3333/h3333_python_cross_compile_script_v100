{
	'repo_type' : 'archive',
	'download_locations' : [
		{ 'url' : 'https://dl.bintray.com/boostorg/release/1.72.0/source/boost_1_73_0.tar.bz2', 'hashes' : [ { 'type' : 'sha256', 'sum' : '4eb3b8d442b426dc35346235c8733b5ae35ba431690e38c6a8263dce9fcbb402' }, ], },
	...
	'_info' : { 'version' : '1.73.0', 'fancy_name' : 'Boost' },
}
