{
    ...
    'branch' : 'main',
	'env_exports' : { # 2022.12.18 per DEADSIX27
		'CFLAGS'   : ' -DFLAC__NO_DLL {original_cflags}', # 2022.12.18 per DEADSIX27
		'CXXFLAGS' : ' -DFLAC__NO_DLL {original_cflags}', # 2022.12.18 per DEADSIX27
		'CPPFLAGS' : ' -DFLAC__NO_DLL {original_cflags}', # 2022.12.18 per DEADSIX27 # 2020.06.20 per https://github.com/fribidi/fribidi/issues/146#issuecomment-646991416
		'LDFLAGS'  : ' -DFLAC__NO_DLL {original_cflags}', # 2022.12.18 per DEADSIX27
