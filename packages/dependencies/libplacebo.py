{
	...
	'depends_on' : [ 'libdovi', 'vulkan_headers', 'vulkan-d3dheaders', 'vulkan_from_windows_dll' , 'lcms2', 'libepoxy',  'shaderc_commit_dependencies', 'spirv-headers', 'spirv-tools', 'spirv-cross', 'glslang', 'shaderc', ], # 2022.12.18 ad libepoxy for opengl # 'vulkan_loader', # 2022.06.28 'spirv-tools' dependency is in glslang
