{
	...
	'custom_ldflag' : ' -Wl,-Bdynamic -fstack-protector-strong -lz -lvulkan -ld3d11 -lintl -liconv ', # 2020.03.19 added -ld3d11 per from libmpv.py also added -lintl -liconv # including -lzimg always throws an error
