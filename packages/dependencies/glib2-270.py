# 2021.07.21 TRY TO BUILD BASED ON RDP';S with meson
{
	...
	'download_locations' : [ # https://fossies.org/linux/misc/
		...
		{ 'url' : 'https://fossies.org/linux/misc/glib-2.70.1.tar.xz', 'hashes' : [ { 'type' : 'sha256', 'sum' : 'f9b7bce7f51753a1f43853bbcaca8bf09e15e994268e29cfd7a76f65636263c0' }, ], }, # https://fossies.org/linux/misc/
	],
	'patches' : [
		...
		('glib2/0001-disable-some-tests-when-static.patch', '-Np1'), 
