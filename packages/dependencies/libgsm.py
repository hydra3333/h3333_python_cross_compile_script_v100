...
#		'folder_name' : 'gsm-1.0-pl18',
#		'patches' : (
#			('https://raw.githubusercontent.com/hydra3333/h3333_python_cross_compile_script_v02/master/patches/gsm-1.0.16.patch', '-p0'),
#			('https://raw.githubusercontent.com/hydra3333/h3333_python_cross_compile_script_v02/master/patches/gsm-1.0.16_Makefile.patch', '-p0'), # toast fails. so lets just patch it out of the makefile..
#		),
#		'needs_configure' : False,
#		'needs_make_install' : False,
#		"run_post_build": (
