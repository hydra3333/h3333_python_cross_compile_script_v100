{ # http://www.quut.com/gsm/
	'repo_type' : 'archive',
	'download_locations' : [
		{ 'url' : 'http://www.quut.com/gsm/gsm-1.0.22.tar.gz', 'hashes' : [ { 'type' : 'sha256', 'sum' : 'f0072e91f6bb85a878b2f6dbf4a0b7c850c4deb8049d554c65340b3bf69df0ac' }, ], }, # ? CORRUPTED ?  HACKED ?
	],
	'folder_name' : 'gsm-1.022',
	'patches' : [
