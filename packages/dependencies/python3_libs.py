...
#}
{
	...
	#'build_options' : 'PREFIX={target_prefix} GENDEF={mingw_binpath}/gendef DLLTOOL={mingw_binpath}/{cross_prefix_bare}dlltool PYTHON_VERSION=3.8.10', # for vapoursynth R53
	## eg 
	...
	'_info' : { 'version' : '3.8.10', 'fancy_name' : 'Python (library-only)' },
}
