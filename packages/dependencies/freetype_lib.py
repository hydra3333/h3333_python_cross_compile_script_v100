{
	...
	'configure_options' : '{autoconf_prefix_options} --build=x86_64-linux-gnu --disable-shared --enable-static --with-zlib={target_prefix} --without-png --with-harfbuzz=no', # TODO get rid of hardcoded build variable # 2019.12.15 ensured static
