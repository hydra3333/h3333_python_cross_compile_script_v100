{
	...
	'run_post_regexreplace' : [
		#'rm -vrf graphengine/', # 2022.12.18 per DEADSIX27 ... but do not remove the folder graphengine since it is not built elsewhere (yet)
	...
	'configure_options' : '--with-sysroot="{self.targetSubPrefix} --host={target_host} --prefix={target_prefix}  --disable-shared --enable-static --enable-x86simd -disable-testapp --disable-example --disable-unit-test --disable-debug', # 2019.12.13
