...
#			('https://raw.githubusercontent.com/hydra3333/h3333_python_cross_compile_script_v02/master/patches/libsoxr-from-Alexpux/0001-libsoxr-fix-pc-file-installation.patch','-Np1'),
#			('https://raw.githubusercontent.com/hydra3333/h3333_python_cross_compile_script_v02/master/patches/libsoxr-from-Alexpux/0002-libsoxr-fix-documentation-installation.patch','-Np1'),
#		],
#		'conf_system' : 'cmake',
