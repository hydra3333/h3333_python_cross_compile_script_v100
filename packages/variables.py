{
	'ffmpeg_config' : # the base for all ffmpeg configurations.
		...
		'--enable-nvdec '
		'--enable-dxva2 '
		'--disable-libmfx ' #'--enable-libmfx ' # 2022.05.25 comment out intel_quicksync_mfx since ffmpeg quicksync no longer detects https://github.com/lu-zero/mfx_dispatch.git as valid.
		'--enable-amf '
