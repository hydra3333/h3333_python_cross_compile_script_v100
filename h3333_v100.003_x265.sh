...
#./cross_compiler_v100_003.py --force --debug --products --dependencies -pl ffmpeg_static_non_free_opencl,x265
#./cross_compiler_v100_003.py --force --debug -p x265
# only use --force if ity's already been fully built, 
# or it breaks if you use it the first time
./cross_compiler_v100_003.py list -p 2>&1 | tee -a ./debug-x265.log
./cross_compiler_v100_003.py list -d 2>&1 | tee -a ./debug-x265.log
...
./cross_compiler_v100_003.py --force --debug -d libx265_multibit_10 2>&1 | tee -a ./debug-x265.log
./cross_compiler_v100_003.py --force --debug -d libx265_multibit_12 2>&1 | tee -a ./debug-x265.log
./cross_compiler_v100_003.py --force --debug -d libx265_multibit 2>&1 | tee -a ./debug-x265.log
./cross_compiler_v100_003.py --force --debug -p x265 2>&1 | tee -a ./debug-x265.log
exit_status=$?
