...
#./cross_compiler_v100_002.py --force --debug --products --dependencies -pl ffmpeg_static_non_free_opencl,x265_multibit
#./cross_compiler_v100_002.py --force --debug -p x265_multibit
# only use --force if ity's already been fully built, 
# or it breaks if you use it the first time
./cross_compiler_v100_002.py list -p 2>&1 | tee -a ./debug.log
./cross_compiler_v100_002.py list -d 2>&1 | tee -a ./debug.log

./Remove_ffmpeg_3333_related_files.sh
rm -fv ./ffmpeg.log
./cross_compiler_v100_002.py --force --debug -p ffmpeg 2>&1 | tee -a ./ffmpeg.log
exit_status=$?
...
rm -fv ./x264.log
./cross_compiler_v100_002.py --force --debug -p x264 2>&1 | tee -a ./x264.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
#
rm -fv ./x265.log
./cross_compiler_v100_002.py --force --debug -p x265 2>&1 | tee -a ./x265.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./mp4box.log
./cross_compiler_v100_002.py --force --debug -p mp4box 2>&1 | tee -a ./mp4box.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./lame.log
./cross_compiler_v100_002.py --force --debug -p lame 2>&1 | tee -a ./lame.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./aom.log
./cross_compiler_v100_002.py --force --debug -p aom 2>&1 | tee -a ./aom.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./sox.log
./cross_compiler_v100_002.py --force --debug -p sox 2>&1 | tee -a ./sox.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./vpx.log
./cross_compiler_v100_002.py --force --debug -p vpx 2>&1 | tee -a ./vpx.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./webp.log
./cross_compiler_v100_002.py --force --debug -d libwebp 2>&1 | tee -a ./webp.log
./cross_compiler_v100_002.py --force --debug -p webp 2>&1 | tee -a ./webp.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./mediainfo.log
./cross_compiler_v100_002.py --force --debug -p mediainfo 2>&1 | tee -a ./mediainfo.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./dav1d.log
./cross_compiler_v100_002.py --force --debug -p dav1d 2>&1 | tee -a ./dav1d.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
rm -fv ./fftw3_dll.log
./cross_compiler_v100_002.py --force --debug -d fftw3_dll_single 2>&1 | tee -a ./fftw3_dll.log
./cross_compiler_v100_002.py --force --debug -d fftw3_dll_double 2>&1 | tee -a ./fftw3_dll.log
./cross_compiler_v100_002.py --force --debug -d fftw3_dll_ldouble 2>&1 | tee -a ./fftw3_dll.log
#./cross_compiler_v100_002.py --force --debug -p fftw3_dll_quad 2>&1 | tee -a ./fftw3_dll.log
./cross_compiler_v100_002.py --force --debug -p fftw3_dll 2>&1 | tee -a ./fftw3_dll.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
./cross_compiler_v100_002.py --force --debug -d libgpg_error_for_libaacs 2>&1 | tee -a ./libaacs_dll.log
./cross_compiler_v100_002.py --force --debug -d libgcrypt_for_libaacs 2>&1 | tee -a ./libaacs_dll.log
./cross_compiler_v100_002.py --force --debug -p libaacs_dll 2>&1 | tee -a ./libaacs_dll.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
#./cross_compiler_v100_002.py --force --debug -p mkvtoolnix 2>&1 | tee -a ./mkvtoolnix.log
#exit_status=$?
#echo "exit_status='$exit_status'"
#if [ $exit_status -ne 0 ]; then
#    echo "Error $exit_status detected"
...
#./cross_compiler_v100_002.py --force --debug -p youtube-dl 2>&1 | tee -a ./youtube-dl.log
#exit_status=$?
#echo "exit_status='$exit_status'"
#if [ $exit_status -ne 0 ]; then
#    echo "Error $exit_status detected"
...
./cross_compiler_v100_002.py --force --debug -p ffmpeg_3333 2>&1 | tee -a ./ffmpeg_3333.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
