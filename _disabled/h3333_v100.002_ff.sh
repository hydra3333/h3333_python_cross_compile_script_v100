...
./cross_compiler_v100_002.py list -p 2>&1 | tee -a ./debug-ff.log
./cross_compiler_v100_002.py list -d 2>&1 | tee -a ./debug-ff.log
...
echo "# `date` ###################################################################################" >>./debug-ff.log
./Remove_ffmpeg_3333_related_files.sh
./cross_compiler_v100_002.py --force --debug -p ffmpeg 2>&1 | tee -a ./debug-ff.log
exit_status=$?
