...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p ffmpeg_static_non_free 2>&1 | tee -a ./debug.log
exit_status=$?
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p ffmpeg_static_non_free_opencl 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p x264 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p x265_multibit 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
#read -p "done x265_multibit press any key to continue"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p mp4box 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p lame 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p aom 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p sox 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p vpx 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p mediainfo 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p dav1d 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
echo "# `date` ###################################################################################" >>./debug.log
echo "# `date` ###################################################################################" >>./debug.log
./cross_compiler_v100_001.py --force --debug -p fftw3_dll 2>&1 | tee -a ./debug.log
exit_status=$?
echo "exit_status='$exit_status'"
if [ $exit_status -ne 0 ]; then
    echo "Error $exit_status detected"
...
#echo "# `date` ###################################################################################" >>./debug.log
#echo "# `date` ###################################################################################" >>./debug.log
#./cross_compiler_v100_001.py --force --debug -p lameENC_DLL 2>&1 | tee -a ./debug.log
#exit_status=$?
#echo "exit_status='$exit_status'"
#if [ $exit_status -ne 0 ]; then
#    echo "Error $exit_status detected"
...
#echo "# `date` ###################################################################################" >>./debug.log
#sudo chmod 777 -R *
#echo 'find . -iname "*.exe" '>>./debug.log
#find . -iname "*.exe" 2>&1 | tee -a ./debug.log
#echo "# `date` ###################################################################################" >>./debug.log
#echo "# `date` ###################################################################################" >>./debug.log
#echo "# `date` ###################################################################################" >>./debug.log
#echo "# `date` ###################################################################################" >>./debug.log
...
mkdir -pv exe_x64_py/noOpenCL 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/ffmpeg_static_non_free_opencl.installed/bin/ffprobe.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/ffmpeg_static_non_free_opencl.installed/bin/ffplay.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/ffmpeg_static_non_free_opencl.installed/bin/ffmpeg.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
#
cp -fv ./workdir/x86_64_products/ffmpeg_static_non_free.installed/bin/ffprobe.exe ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/ffmpeg_static_non_free.installed/bin/ffplay.exe ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/ffmpeg_static_non_free.installed/bin/ffmpeg.exe ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
#
cp -fv ./workdir/x86_64_products/x265_multibit_hg.installed/bin/x265.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/x264_git.installed/bin/x264.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/x264_git.installed/bin/x264.exe ./exe_x64_py/x264-mp4.exe 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/vpx_git.installed/bin/vpxenc.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/vpx_git.installed/bin/vpxdec.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/toolchain/x86_64-w64-mingw32/x86_64-w64-mingw32/bin/webpmux.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/toolchain/x86_64-w64-mingw32/x86_64-w64-mingw32/bin/webpinfo.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/mp4box_git.installed/bin/MP4Box.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/lame-3.100.installed/bin/lame.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/toolchain/x86_64-w64-mingw32/x86_64-w64-mingw32/bin/rtmpdump.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/toolchain/x86_64-w64-mingw32/x86_64-w64-mingw32/sbin/rtmpsuck.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/mediainfo_git.installed/bin/mediainfo.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/aom_git.installed/bin/aomdec.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/aom_git.installed/bin/aomenc.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/sox_git.installed/bin/sox.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/sox_git.installed/bin/soxi.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/dav1d.installed/bin/dav1d.exe ./exe_x64_py/ 2>&1 | tee -a ./debug.log
#
cp -fR ./workdir/x86_64_products/ffmpeg_static_non_free_opencl/presets ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fR ./workdir/x86_64_products/ffmpeg_static_non_free_opencl/doc ./exe_x64_py/ 2>&1 | tee -a ./debug.log
#
cp -fR ./workdir/x86_64_products/ffmpeg_static_non_free_opencl/presets ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
cp -fR ./workdir/x86_64_products/ffmpeg_static_non_free_opencl/doc ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
#
cp -fv ./workdir/x86_64_products/fftw3_dll_single/bin/libfftw3f-3.dll ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/fftw3_dll_double/bin/libfftw3-3.dll ./exe_x64_py/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/fftw3_dll_ldouble/bin/libfftw3l-3.dll ./exe_x64_py/ 2>&1 | tee -a ./debug.log
#cp -fv ./workdir/x86_64_products/fftw3_dll_quad/bin/libfftw3q.dll ./exe_x64_py/ 2>&1 | tee -a ./debug.log
#
cp -fv ./workdir/x86_64_products/fftw3_dll_single/bin/libfftw3f-3.dll ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/fftw3_dll_double/bin/libfftw3-3.dll ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
cp -fv ./workdir/x86_64_products/fftw3_dll_ldouble/bin/libfftw3l-3.dll ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
#cp -fv ./workdir/x86_64_products/fftw3_dll_quad/bin/libfftw3q.dll ./exe_x64_py/noOpenCL/ 2>&1 | tee -a ./debug.log
#
#cp -fv ./workdir/x86_64_products/lameENC_DLL-3.100.installed/bin/libmp3lame-0.dll ./exe_x64_py/lame_enc.dll 2>&1 | tee -a ./debug.log
